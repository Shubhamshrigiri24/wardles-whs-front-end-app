...
import GetEmail from '../../src/GetEmail';
    ...
    // <Grid>
            ...
            <Paper elevation={0} style={paperStyle2}>
              ...
              <div style={{marginLeft:15}}>
                ...
                <Button  onClick={() => {navigate("/thankyou");}} variant="contained" size="Large" disableElevation style={{background: "#F7FBFF",color:"#07283C", marginBottom:"17px", border: "1.5px solid #07283C", fontSize:"18px", textTransform: "none"}} fullWidth type="submit" >Resend email</Button>
