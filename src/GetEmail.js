...
export default function GetEmail() {
    ...
    return (
        ...
        <Button href="#contained-buttons" color="primary" size="large" style={{textTransform:"none"}} fullWidth endIcon={<ArrowForwardIosIcon/>}  onClick={handleOpen}>Didn’t get an email?</Button>
