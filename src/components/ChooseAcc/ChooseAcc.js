...
export default function ChooseAcc() {
  ...
  return (
      <Container style={{display:"flex",justifyContent:"center",alignItems:"center",height:"70vh",width:"100vh"}}>
        <div>
        <h1 style={{fontFamily:"Gilroy Alt",textAlign:"center"}}>Which type of account would you like to create?</h1>
        ...
        <Button variant="contained" fullWidth color="primary" size="large" style={{textTransform:"none",fontSize:"16px",fontFamily:"Gilroy Alt", backgroundColor:"#FFCD00",color:"#07283C",marginTop:"10%",height:"20%",borderRadius:"1px"}}>Continue</Button>
        </Box>
      </Container>
      <Container maxWidth="sm">
        <Box p={2} sx={{width: "364px",height: "330px", background: "#FFFFFF",border: "1px solid #CEDCE9",boxSizing: "border-box",boxShadow: "2px 2px 7px rgba(0, 0, 0, 0.07)",borderRadius: "4px" }}>
